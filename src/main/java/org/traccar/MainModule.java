...
import org.traccar.handler.events.RefuelEventHandler;
...
import org.traccar.handler.events.MissionEventHandler;
...
public class MainModule extends AbstractModule {
    ...
    @Provides
    public static MissionsManager provideMissionsManager() {
        return Context.getMissionsManager();
    }
    ...
    @Singleton
    @Provides
    public static RefuelEventHandler provideRefuelEventHandler(IdentityManager identityManager) {
        return new RefuelEventHandler(identityManager);
    }
    @Singleton
    @Provides
    ...
    @Singleton
    @Provides
    public static MissionEventHandler provideMissionEventHandler(
            IdentityManager identityManager, MissionsManager missionsManager) {
        return new MissionEventHandler(identityManager, missionsManager);
    }
