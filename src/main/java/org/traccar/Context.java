...
public final class Context {
    ...
    public static MissionsManager getMissionsManager() {
    ...
    private static void initEventsModule() {
        ...
        missionsManager = new MissionsManager(dataManager);
    ...
    public static <T extends BaseModel> BaseObjectManager<T> getManager(Class<T> clazz) {
        ...
        else if (clazz.equals(Mission.class)) {
            return (BaseObjectManager<T>) missionsManager;
        }
